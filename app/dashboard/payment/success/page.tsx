...
export default function PaymentSuccess() {
  ...
  const orderId = searchParams.get("token") || searchParams.get("PayerID") || searchParams.get("payerId") || searchParams.get("offer_id");
      ...
      <div className="bg-white shadow-md rounded-lg p-8 text-center max-w-md w-full">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-4">
          {status === STATUS.SUCCESS ? "Payment Successful" : 
           status === STATUS.FAILED || status === STATUS.ERROR ? "Payment Failed" : 
           "Processing Payment"}
        </h1>
