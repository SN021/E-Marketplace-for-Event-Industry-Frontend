...
export async function DELETE(req: NextRequest) {
  ...
  const deleteSteps = [
    supabase.from("offers").delete().eq("conversation_id", convoId),
    supabase.from("messages").delete().eq("conversation_id", convoId),
    supabase.from("conversations").delete().eq("service_id", id),
